...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.4\ispfpga\bin\nt\scuba.exe -w -n AMIV_PLL -lang verilog -synth lse -arch xo2c00 -type pll -fin 37.125 -fclkop 148.5 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Tue Jun 23 20:24:11 2015 */


`timescale 1 ns / 1 ps
module AMIV_PLL (CLKI, CLKOP)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute AMIV_PLL dont_touch true 
    input wire CLKI;
    output wire CLKOP;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             ...
             /* synthesis FREQUENCY_PIN_CLKI="37.125000" */
    ...
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKI 37.125000
